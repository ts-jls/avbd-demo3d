...
int main()
{
    ...
    Rigid *capsules[5];
    capsules[0] = Rigid::makeCapsule(&solver, r, h, 0.05f, 0.5f, {-1.6f, 0, 0.5f + r + 0.05f});
    capsules[1] = Rigid::makeCapsule(&solver, r, h, 0.05f, 0.5f, {0.0f, 0, 0.5f + r + 0.05f});
    capsules[2] = Rigid::makeCapsule(&solver, r, h, 0.05f, 0.5f, {1.6f, 0, 0.5f + r + 0.05f});
    capsules[3] = Rigid::makeCapsule(&solver, r, h, 0.05f, 0.5f, {-0.8f, 0, 1.35f});
    capsules[4] = Rigid::makeCapsule(&solver, r, h, 0.05f, 0.5f, {0.8f, 0, 1.35f});
    for (int i = 0; i < 5; ++i)
